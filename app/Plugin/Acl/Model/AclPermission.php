    ...
    public function getAllowedActionsByRoleId($roleId) {
        ...
        $acosTree = $this->AclAco->generateTreeList(array(
            'AclAco.parent_id !=' => null,
                ), '{n}.AclAco.id', '{n}.AclAco.alias',null,'_');
       $acosTree1 =  $this->AclAco->find('threaded', array('conditions'=>array('AclAco.parent_id !=' => null),'fields'=>array('AclAco.id', 'AclAco.alias')));
        $acos = array();
        //pr($acosTree);die;
        $controller = null;
