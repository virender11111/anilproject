    ...
    <div class="container">
        <ul class="breadcrumb-ul" vocab="http://schema.org/" typeof="BreadcrumbList">
            ...
            <li class="last" property="itemListElement" typeof="ListItem">
                <a href="<?php echo Router::url(array('controller' => 'blog_posts', 'action' => 'view', 'slug' => $this->params['slug'], 'plugin' => 'blog')); ?>" property="item" typeof="WebPage"><span property="name">Blog Detail</span></a>
