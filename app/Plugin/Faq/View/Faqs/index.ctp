                    ...
                    <div class="inner-comtaint-art">
                        <div class="questions-list-containt">
                            ...
                            foreach ($faqs as $faq) {
                                ...
                                if ($category != $faq["FaqCategory"]["name"]) {
                                    ?>
                                    <div class="custometitle-bar">
                                        <span class="custometitle-bar-inner">
                                            <h4><?php echo $faq["FaqCategory"]["name"]; ?></h4>
                                        </span>
                                    </div>
                                ...
                                <div class="col-sm-12 question-containt faq-line"> 
                                	...
                                	<div class="faqq"><a class="faq" href="javascript:void(0);"><?php echo $faq["Faq"]["question"]; ?></a></div>
                                    <p id="hidefaq"><?php echo $faq["Faq"]["description"]; ?></p>
                                
                                </div>
                                <?php
                                $category = $faq["FaqCategory"]["name"];
                            }
                            ?>
