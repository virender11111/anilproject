...
class FaqCategoriesController extends AppController {
    ...
    public function admin_delete($id = null) {
        ...
        $faqExists = $this->Faq->CheckFaqExists($id);
        //echo $faqExists;die;
        if ($faqExists == 0) {
            ...
            $this->Session->setFlash(__('faqExists', Inflector::humanize(Inflector::underscore($this->modelClass))), 'message', array('class' => 'danger'), 'admin');
        }
