        ...
        $.fn.MultiFile = function (options) {
            ...
            this
                    ...
                    .each(function () {
                        ...
                        if (o.maxfile > 1)
                            o.maxfile = o.maxfile * 1024;
                        if (o.maxsize > 1)
                            o.maxsize = o.maxsize * 1024;

                        //===

                        // HTML5: enforce multiple selection to be enabled
                        if (o.max > 1)
                            MultiFile.E.attr('multiple', 'multiple').prop('multiple', true);
                        ...
                        MultiFile.addSlave = function (slave, slave_count) {
                            ...
                            // disable?
                            if (disable_slave)
                                $(slave).attr('disabled', 'disabled').prop('disabled', true);
                        ...
                        MultiFile.addToList = function (slave, slave_count, files) {
                            ...
                            var
                                    hh = $('<div class="col-md-3 col-sm-3 col-xs-6 Add-Column"></div>'),
                                    r = $('<div class="element-col"></div>'),
                                    dltrow = $('<div class="Radio-btn"></div>'),
                                    radiobutton = $('<label><input name="data[LessonAttachment][0][attachment][' + slave_count + '][is_default]" type="radio" class="make_me_default" value=""><input type="hidden" name="data[LessonAttachment][0][attachment][' + slave_count + '][id]" /><span>Primary Photo</span></label>'),
                                    b = $('<a class="MultiFile-remove trash-button lesson-trashbtn" href="#' + MultiFile.wrapID + '">' + MultiFile.STRING.remove + '</a>')
                            ...
                            MultiFile.list.append(hh.append(r.append(' ', names)).append(dltrow.append(radiobutton, b)));
                ...
                $.extend($.fn.MultiFile, {
                    ...
                    reset: function () {
                        ...
                        if (mf)
                            $(mf.list).find('a.MultiFile-remove').click();
                        return $(this);
                    },
                    /**
                ...
                $.fn.MultiFile.options = {//$.extend($.fn.MultiFile, { options: {
                    ...
                    // previews
                    preview: false,
                    previewCss: 'height:183px; max-width:275px;',
                ...
                $(document).on("click", '.make_me_default', function () {
                    var current = $(this);
                    $('input.make_me_default').removeAttr("checked");
                    $('input.make_me_default').attr("value", "");
                    current.val("1");
