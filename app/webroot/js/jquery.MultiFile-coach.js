        ...
        $.fn.MultiFile = function (options) {
            ...
            this
                    ...
                    .each(function () {
                        ...
                        MultiFile.addToList = function (slave, slave_count, files) {
                            ...
                            var
                                    ...
                                    //radiobutton = $('<label><input name="Primary-Photo" type="radio" value=""><span>Primary Photo</span></label>'),
                                    b = $('<a class="MultiFile-remove trash-button coach-trashbtn" href="#' + MultiFile.wrapID + '">' + MultiFile.STRING.remove + '</a>')
                            ...
                            MultiFile.list.append(hh.append(r.append(' ', names, b)));
                ...
                $.fn.MultiFile.options = {//$.extend($.fn.MultiFile, { options: {
                    ...
                    // previews
                    preview: false,
                    previewCss: 'height:173px; max-width:240px; width:240px;',
