...
//    |   |   |   |   |- plugin.min.js
$site_path =  explode('app/webroot/',"http://$_SERVER[SERVER_NAME]$_SERVER[PHP_SELF]");
//$base_url = substr($_SERVER['HTTP_REFERER'], 0, strpos($_SERVER['HTTP_REFERER'], "admin"));
$base_url = $site_path[0];//"http://192.168.100.96/hemant/tshirt/pro/";
...
$thumbs_base_path = '../../../../uploads_thumb/'; // relative path from filemanager folder to thumbs folder (with final /)
// OPTIONAL SECURITY
