...
//          var dfAPI = webroot+"admin/dashboard/dashboardDate";
//              var campaigns = '';
//              $.getJSON(dfAPI, function (json) {
            
            var urlGraph= 'Dashboard/cntCreatedCamp';       
                $.ajax({
        dataType: "json",
        type: "GET",
        evalScripts: true,       
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            var x = item.datapoint[0].toFixed(2),
                                ...
                                showChartTooltip(item.pageX, item.pageY, item.datapoint[0], item.datapoint[1] + ' Campaigns created');
