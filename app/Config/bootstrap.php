...
Configure::write('default.model', 1);
Configure::write('default.score', 'NA');
Configure::write('dashboard.MMLimit', 5);

Configure::write('Stripe.TestSecret', 'sk_test_EdIz0SbUFdZ8GaAokxOxQmsJ');
//Configure::write('Stripe.LiveSecret', 'sk_live_SOJPx92NRVVGc1pMYAToaIoI');
Configure::write('Stripe.testPublishKey', 'pk_test_saiYYlyCNgO2yZq6MuQw7EKX');
//Configure::write('Stripe.livePublishKey', 'pk_test_saiYYlyCNgO2yZq6MuQw7EKX');
Configure::write('Stripe.mode', 'Test');
Configure::write('Stripe.currency', 'usd');
Configure::write('Site.currencySign', '&dollar;');

//Configure::write('beta_enable', TRUE);
/**
 * Libraries
 */
