...
class JobsController extends AppController {
    ...
    public function quick_enquiry() {
        if ($this->request->is("post") && !empty($this->request->data)) {
            ...
            $ccEmail = Configure::read('Site.ccemail');
            if ($this->Job->saveAll($this->request->data)) {
                ...
                if($this->request->data['Job']['job_category_id'] == 1) {
                    $jobCategory = "General Enquiry";
                } else if($this->request->data['Job']['job_category_id'] == 2) {
                    $jobCategory = "Clinical Enquiry";
                } else if($this->request->data['Job']['job_category_id'] == 3) {
                    $jobCategory = "Buzzz Enquiry";
                }

                $newsletter = (($this->request->data['Job']['newsletter'] == 1) ? "Yes" : "No");

                $body = "An enquiry has been posted by the user <br/><br/>Name : ".$this->request->data['Job']['name']."<br/><br/>Email : ".$this->request->data['Job']['email']."<br/><br/>Enquiry Type : ".$jobCategory."<br/><br/>Phone no : ".$phone."<br/><br/>Request call back : ".$request."<br/><br/>Newsletter Subscription : ".$newsletter."<br/><br/>Company : ".$this->request->data['Job']['company']."<br/><br/>Message : ".$this->request->data['Job']['comments'];
                $bodyForUser = "Your enquiry has been submitted successfully with the following information <br/><br/>Name : ".$this->request->data['Job']['name']."<br/><br/>Email : ".$this->request->data['Job']['email']."<br/><br/>Enquiry Type : ".$jobCategory."<br/><br/>Phone no : ".$phone."<br/><br/>Request call back : ".$request."<br/><br/>Newsletter Subscription : ".$newsletter."<br/><br/>Company : ".$this->request->data['Job']['company']."<br/><br/>Message : ".$this->request->data['Job']['comments'];
            	


                // $Email = new CakeEmail();
                // $Email->from(array('me@example.com' => 'My Site'));
                // $Email->to(trim($adminEmail));
                // $Email->subject('About');
                // $Email->send($body);
                // die("asa");
                ...
                //$headers .= "From: enquiry@frontiersupport.co.uk" . "\r\n" ."CC: sagar.jajoriya@planetwebsolution.com";
                $headers = "From: enquiry@frontiersupport.co.uk" . "\r\n" ."CC: ".Configure::read('Site.ccemail');

                //send mail to user
                $headersForUser  = 'MIME-Version: 1.0' . "\r\n";
                $headersForUser .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                $headersForUser .= "From: enquiry@frontiersupport.co.uk";
                $txtForUser = $bodyForUser;
                mail($this->request->data["Job"]["email"], $subject, $txtForUser, $headersForUser);
                ...
                $email->to(Configure::read('Site.email'));
                $email->cc(Configure::read('Site.ccemail'));
    ...
    public function modal_quick_enquiry() {
        ...
        if ($this->request->is("post") && !empty($this->request->data)) {
            ...
            $extension = pathinfo($this->request->data["Job"]["cv_upload"]["name"], PATHINFO_EXTENSION);
            if ($this->Job->saveAll($this->request->data)) {
             ...
             //    }   
                ...
                $htmlbody = "An enquiry has been posted by the user <br/><br/>Name : ".$this->request->data['Job']['name']."<br/><br/>Email : ".$this->request->data['Job']['email']."<br/><br/>Job Category : ".$job_category."<br/><br/>Phone no : ".$phone."<br/><br/>Request call back : ".$request."<br/><br/>Message : ".$this->request->data['Job']['comments'];
                $htmlbodyForUser = "Your CV has been submitted successfully with the following information <br/><br/>Name : ".$this->request->data['Job']['name']."<br/><br/>Email : ".$this->request->data['Job']['email']."<br/><br/>Job Category : ".$job_category."<br/><br/>Phone no : ".$phone."<br/><br/>Request call back : ".$request."<br/><br/>Message : ".$this->request->data['Job']['comments'];
                $to = Configure::read('Site.email');
                ...
                $message .= $htmlbody;
                $message .="\r\n\r\n--PHP-alt-$random_hash--\r\n\r\n";
                $message .= "--PHP-mixed-$random_hash\r\n"."Content-Type: application/zip; name=\"Resume.".$extension."\"\r\n"."Content-Transfer-Encoding: base64\r\n"."Content-Disposition: attachment\r\n\r\n";
                $message .= $attachment;
                ...
                $headersForUser .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                $headersForUser .= "From: enquiry@frontiersupport.co.uk";
                mail($this->request->data['Job']['email'], $subject, $htmlbodyForUser, $headersForUser);                
