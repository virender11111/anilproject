 ...
 */
class SpecialCategoriesController extends AppController {
     ...
     * @var array
     */
    public $uses = array('SpecialCategory');
    public $layout = 'home';
    ...
    public function admin_index() {
    	...
    	$this->paginate = array(
    			...
    			'group' => 'SpecialCategory.id',
    			'order' => array('SpecialCategory.id' => 'DESC')
    	);
    	
    	// Handle out of exception
    	try {
    		$data = $this->paginate('SpecialCategory');
    ...
    public function admin_add() {
        ...
        if (!empty($this->request->data)) {
            ...
            if ($this->SpecialCategory->saveAll($this->request->data)) {
    ...
    public function admin_edit($id = null) {
        ...
        $this->SpecialCategory->id = $id;
        if (!$this->SpecialCategory->exists())
            throw new NotFoundException(__(''));
        $this->set('title_for_layout', __('Edit Special Category'));
        $this->set('title', __('Service <small> Edit Special Services</small>'));
        if ($this->request->is('post')) {
        	if(empty($this->request->data['SpecialCategory']['image']['name'])){
        		unset($this->request->data['SpecialCategory']['image']);
        	}
        	 $this->request->data['SpecialCategory']['id'] = $id;
            if ($this->SpecialCategory->saveAll($this->request->data)) {
                $this->Session->setFlash(__('saved', $this->modelClass), 'message', array('class' => 'success'), 'admin');
            ...
            $this->request->data = $this->SpecialCategory->read(null, $id);
        }
        $service_id = $id;
        $this->set(compact('title_for_layout','server_id'));
    ...
    public function admin_delete($id = null) {
        if ($this->SpecialCategory->delete($id)) {
