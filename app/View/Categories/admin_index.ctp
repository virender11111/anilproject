...
//$tableHeaders[] = $this->Paginator->sort(__('country_id'),'Country Name');
$tableHeaders[] = $this->Paginator->sort(__('name'),'Category Name');
...
$tableHeaders[] = '';
$tableHeaders[] = '';
//$tableHeaders[] = $this->Form->input($modelClass.'.state', array('label' => false, 'class' => 'form-control form-filter input-sm', 'div' => false));
