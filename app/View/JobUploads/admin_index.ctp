...
// $this->Html->addCrumb(ucfirst('Jobs'), array('action' => 'index'));
// $this->extend('/Common/admin_index');
...
$tableHeaders[] = array($this->Paginator->sort(__('job_category_id')) => array('class'=>'job_category_class text-center'));
...
/* _______________ Filter _______________________ */
$tableHeaders = array();

$tableHeaders[] = "";
$tableHeaders[] = $this->Form->input($modelClass . '.job_category_id', array('label' => false, 'class' => 'form-control form-filter input-sm', 'div' => false, 'options' => array('4' => 'Care & Support', '5' => 'Supported Employment', '6' => 'Other Positions'), 'empty' => 'Select...'));
$tableHeaders[] = "";
$tableHeaders[] = "";
$tableHeaders[] = "";
$tableHeaders[] = "";
