...
$tableHeaders[] = $this->Paginator->sort(__('team_id'));
...
$tableHeaders = array();
$tableHeaders[] = '';
$tableHeaders[] = $this->Form->input($modelClass . '.team_id', array('label' => false, 'class' => 'form-control form-filter input-sm', 'div' => false, 'options' => $all_teams, 'empty' => 'Select...'));
$tableHeaders[] = '';
$tableHeaders[] = '';
$tableHeaders[] = '';
$tableHeaders[] = '';
