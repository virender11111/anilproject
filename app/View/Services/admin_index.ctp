...
$tableHeaders[] = $this->Paginator->sort(__('short_description'),'Short Description');
...
/**************************************/
$addBtn = $this->Html->link('<i class="fa fa-plus"></i> <span class="hidden-480">New Service</span>', array('action' => 'add'), array('class' => 'btn default green-haze-stripe', 'escape' => false));
...
foreach ($listAll as $listOne) {
    ...
    $row[] = $this->Text->truncate($listOne[$modelClass]['short_description'],90,array('ellipsis' => '...','exact' => false));
