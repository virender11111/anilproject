<?php
$this->Html->addCrumb(ucfirst("Images"), array('action' => 'index'));
        ...
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-new thumbnail">
                ...
                if (!empty($this->request->data[$modelClass]['image']) && !empty($this->request->data[$modelClass]['id'])) {
                    echo $this->Image->img('brand/image/' . $this->request->data[$modelClass]['id'] . '/' . $this->request->data[$modelClass]['image'], 200, 200, array(), 'no-image.jpg');
